...
id: 'web-blog-first-eula-post'  # 设置唯一的ID
title: '版权声明与使用条款'
pubDate: '2024-12-24'
description: '您继续访问或以其他方式使用本站，即表示您同意并遵守以下条款'
author: '星影'
cover:
    url: 'https://images.pexels.com/photos/5669602/pexels-photo-5669602.jpeg'
    square: 'https://images.pexels.com/photos/5669602/pexels-photo-5669602.jpeg'
    alt: '法律文书与天平象征'
tags: ["版权声明", "免责声明", "隐私协议", "用户协议"]
theme: 'light'
featured: true
---
...
- 邮箱: admin@xingying.us.kg 或 admin@mail.xingying.us.kg
...
<!-- 引入 Cusdis 评论 -->
<aside>
  <CusdisComment id="unique-article-id" />
</aside>